            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item active"> Student Year Add
                  </li>
                </ol>
              </div>
...
<div class="col s9 m9 l9">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form method="POST" action="{{ route('student.year.store') }}"> @csrf
            <div class="row">
                     
                        
                        <div class="input-field col m6 s9">
                            <input id="year" type="text" name="year" class="block mt-1 w-full @error('year') is-invalid @enderror">
