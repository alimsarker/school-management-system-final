...
<div class="col s9 m9 l9">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form method="POST" action="{{ route('designation.update',$editdata->id) }}"> @csrf
            <div class="row">
                     
                        
                        <div class="input-field col m6 s9">
                            <input id="title" type="text" name="title" value="{{ $editdata->title }}" class="block mt-1 w-full @error('title') is-invalid @enderror">
                            <label for="title">Update Designation</label>
                            @error('title')
