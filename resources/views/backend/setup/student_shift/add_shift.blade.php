...
<div class="col s9 m9 l9">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form method="POST" action="{{ route('student.shift.store') }}"> @csrf
            <div class="row">
                     
                        
                        <div class="input-field col m6 s9">
                            <input id="shift_name" type="text" name="shift_name" class="block mt-1 w-full @error('shift_name') is-invalid @enderror">
                            <label for="shift_name">Student Shift Name Insert</label>
                            @error('shift_name')
