...
<div class="col s9 m9 l9">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form method="POST" action="{{ route('school.subject.store') }}"> @csrf
            <div class="row">
                     
                        
                        <div class="input-field col m6 s9">
                            <input id="school_subject_name" type="text" name="school_subject_name" class="block mt-1 w-full @error('school_subject_name') is-invalid @enderror">
                            <label for="school_subject_name">School Subject Name</label>
