                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item active">  Employee Leave 
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Employee Leave Edit</h4>
                        <form method="POST" action="{{ route('employee.leave.update',$editData->id) }}"> @csrf
                        <div class="row">
                                    ...
                                    @foreach($employee as $value)
                                            <option value="{{ $value->id }}" {{($editData->employee_id=$value->id)? 'selected':'' }}> {{ $value->name }}</option>
                                            @endforeach                           
                            ...
                            <label>Select Employee Name</label>
                                    ...
                                    <div class="input-field col m6 s9">
                                    <input type="date" name="start_date" class="block mt-1 w-full" required=""  value="{{ $editData->start_date }}">
                       ...
                       <input type="text" name="name" id="add_another" class="block mt-1 w-full" placeholder="Write Purpose" style="display: none;"> 
                                    ...
                                    <div class="input-field col m6 s9">
                                        <input type="date" name="end_date" class="block mt-1 w-full" required=""  value="{{ $editData->end_date }}">
