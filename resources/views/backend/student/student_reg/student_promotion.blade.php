...
<div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              ...
              <h5 class="breadcrumbs-title mt-0 mb-0"><span>Student Promotion</span></h5>
...
<div class="col s12 m12">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
          <h4 class="card-title">Promotion Student </h4>
          <form method="POST" action="{{ route('student.class.promotion',$editdata->student_id ) }}" enctype="multipart/form-data"> @csrf
              ...
              <div class="row  mb-5 mr-5">
                <!-- <div class="input-field col s12"> -->
                  <button class="btn cyan waves-effect waves-light right" type="submit" value="Promotion" name="action">Promotion to next Class
