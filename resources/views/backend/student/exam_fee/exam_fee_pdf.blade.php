...
<table id="customers">
  ...
  <img src="{{ public_path() . $image_path }}" width="100" height="50">
    ...
    <td><b> Office Copy</b><br>Student Pay Slip<br><b> {{ $exam_type }} Fee</b></td>
    <td>
...
<table id="customers">
  ...
  <tr>
    <td>8</td>
    <td><b>Student Exam Fee :</b></td>
    <td>{{ $originalfee }} Tk For  <b>{{ $exam_type }} Fee<b> </td>
  </tr>
  ...
  <tr>
    ...
    <td>{{ $finalfee }} Tk For  <b> {{ $exam_type }} Fee</b></td>
  </tr>
...
<br> 
  ...
  <img src="{{ public_path() . $image_path }}" width="100" height="50">
    ...
    <td><b> Student Copy</b><br>Student Pay Slip<br><b>  {{ $exam_type }} Fee </b></td>
