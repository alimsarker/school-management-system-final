        ...
        <div class="col m12 s12">
          <div class="card gradient-45deg-light-green-cyan box-shadow-none border-round mr-1 mb-1">
            ...
            <div class="row">  <!--  //start 1sth row -->
               ...
               <div class="input-field col m3 s12">
                     <select name="exam_type_id" id="exam_type_id"  class="block mt-1 w-full">
                        ...
                        <label class="white-text">Select  Exam Name</label>
                  </div> 
...
<script type="text/javascript">
  $(document).on('click','#search',function(){
    ...
    var  exam_type_id = $('#exam_type_id').val();
     $.ajax({
      url: "{{ route('student.exam_type.fee.classwise.get')}}",
      type: "get",
